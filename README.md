# IT 140 Module Three: Introduction to Flowcharts and Pseudocode
...
To complete this activity, follow the Software Development Life Cycle (SDLC). The top-level steps are listed below. See the [To-Do List](./paycheck_calculator_todo.md) for detailed, step-by-step instructions.

## Getting Started

1. **Analyze** the [problem and requirements](./analysis/paycheck_calculator_srs.md) to understand what needs to be done. Record your understanding of the problem and requirements in your [SDW worksheet](./analysis/paycheck_calculator_sdw.md).

2. **Design** a solution that meets specification. Review the [Software Design Document](./design/paycheck_calculator_sdd.md), {{along with its | and create a}} [flowchart](./design/paycheck_calculator.drawio) and low-level [pseudocode](./design/paycheck_calculator.pseudo).

3. **Construct** a working program in [`paycheck_calculator.py`](./src/paycheck_calculator.py) that implements the designed solution.
...
```text
it140_m3_paycheck_calculator/
│
├── analysis/                        # 1. Analysis: understand the problem
│   ├── paycheck_calculator_sdw.md   # Software Development Worksheet (SDW) to plan your work
│   └── paycheck_calculator_srs.md   # Software Requirements Specification (SRS)
│
├── design/                          # 2. Design: plan the solution
│   ├── paycheck_calculator_sdd.md   # Software Design Document (SDD)
│   ├── paycheck_calculator.drawio   # Flowchart: visual outline of project logic
│   └── paycheck_calculator.pseudo   # Pseudocode: step-by-step logic before coding
│
├── src/                             # 3. Construction: write the code
│   └── paycheck_calculator.py       # Python source (src) code file
│
├── tests/                           # 4. Test: check that code meets requirements
│   └── test_paycheck_calculator.py  # Automated integration tests
│
├── paycheck_calculator_todo.md      # Step-by-step directions for this activity
